...
if __name__ == '__main__':
    ...
    eval_parser.add_argument('--sat_gain', type=float, default=1.1)
    eval_parser.add_argument('--dark_threshold', type=float, default=0.4)
    ...
    eval_net = CIDNet(
        ...
        dark_threshold=ep.dark_threshold
    ).cuda()
